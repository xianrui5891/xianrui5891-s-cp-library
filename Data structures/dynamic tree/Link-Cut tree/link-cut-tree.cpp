...
,class pushup_oper=default_pushup_oper<answer_type>
,class pushdown_oper=default_pushdown_oper<input_type>
,class assignment_oper=default_assignment_oper<answer_type,input_type>>class lct:
protected splay<answer_type,input_type,pushup_oper,pushdown_oper,assignment_oper,less<answer_type>>{
    protected:
